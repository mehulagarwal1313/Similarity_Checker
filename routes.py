...
def create_assignment():
    if request.method == 'POST':
        ...
        db.session.commit()
        folder_path = r'C:\Users\Rhythm\OneDrive\Desktop\IDE for similarity\IDE for similarity\Online_Programming_Assignment_Portal-main (2)\Online_Programming_Assignment_Portal-main\Online_Programming_Assignment_Portal-main\src\\'+t
...
def check_similarity(assignment_id):
    topic = (Assignment.query.filter_by(id=assignment_id).first()).topic
    start_folder = r'C:\Users\Rhythm\OneDrive\Desktop\IDE for similarity\IDE for similarity\Online_Programming_Assignment_Portal-main (2)\Online_Programming_Assignment_Portal-main\Online_Programming_Assignment_Portal-main\src'  # Replace with the path to start searching
    subfolder_name = topic
    folder_path = find_subfolder_path(start_folder, subfolder_name)
...
def show_clusters():
    ...
    # Add your logic here to process and render the cluster data visualization.
